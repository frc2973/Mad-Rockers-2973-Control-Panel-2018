...
add a map with the LRR thing
redo the @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ in camera.h.... i think it is redundant with the hbitmap bitmap thing
...
/*
	This program was developed for MadRockers 2973 by Evan Krohn. Copyright resides with the team. We do not copyright or own the libraries used, including
	Boost, OpenCV, GDIPlus, and WinAPI.
*/
                     ...
                     _In_ int       nCmdShow)
{
	...
	controlPanel->initialize(globalParent, hInstance);
...
{
	if (controlPanel)
		if (controlPanel->WndProc(hWnd, message, wParam, lParam))
			return 0;
